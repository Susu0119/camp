    ...
    <div class="flex w-full items-center justify-between">
      <div class="flex h-[50px] w-full flex-1 shrink items-center gap-3.5 rounded-xl bg-[#E5E5E5] px-2.5 py-1.5">
        <div class="flex h-full flex-1 items-center gap-2.5">
          ...
          <input placeholder="캠핑장명을 입력하세요." class="flex-1 gap-2.5 my-auto select-none text-[#71717A] placeholder-[#71717A] focus:outline-none" type="text" value={value} onChange={(e) => onChange(e.target.value)} />
        </div>
      </div>
    </div>
  );
