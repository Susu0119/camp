...
export default function LoginLogo() {
  return (
    <header className="flex relative gap-1 self-center max-w-full text-6xl whitespace-nowrap w-[351px] max-md:text-4xl">
      <img
      ...
      />
      <h1 className="flex-auto w-[230px] text-white max-md:text-4xl">
        Campia
      </h1>
    </header>
  );
