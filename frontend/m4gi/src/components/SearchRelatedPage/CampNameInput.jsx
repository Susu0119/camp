...
export default function CampsiteNameInput() {
  return (
    <div class="flex w-full items-center justify-between">
      <div class="flex h-[60px] w-full flex-1 shrink items-center gap-3.5 rounded-xl bg-[#E5E5E5] px-2.5 py-1.5">
        <div class="flex h-full flex-1 items-center gap-2.5">
          ...
          <input placeholder="캠핑장명을 입력하세요." class="h-full w-full text-[#141414] placeholder-[#71717A] focus:outline-none" type="text" />
        </div>
      </div>
    </div>
  );
