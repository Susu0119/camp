  ...
  return (
    <>
      ...
      <section className="flex flex-col gap-1 items-start self-stretch px-4 pt-4 pb-5 bg-purple-200 rounded-md">
        ...
        <p className="text-base text-zinc-800 max-sm:text-sm">입실일: {startDate} - 입실 시간: {checkinTime}</p>
        <p className="text-base text-zinc-800 max-sm:text-sm">퇴실일: {endDate} - 퇴실 시간: {checkoutTime}</p>
